			...
			<div class="col-sm-10">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-sm-4" >
							<a href="#"></a><img id="imgb" src="produtos/pantufa.jpg" >
							<h2>Pantufa</h2>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						*/
						...
						this.page.url = leinsmanncomercial.pe.hu/pantufa.php; // Replace PAGE_URL with your page's canonical URL variable
						this.page.identifier = 'pantufa5'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
						};
