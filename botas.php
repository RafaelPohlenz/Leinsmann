				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						*/
						...
						this.page.url = leinsmanncomercial.pe.hu/botas.php; // Replace PAGE_URL with your page's canonical URL variable
						this.page.identifier = 'botas2'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
						};
