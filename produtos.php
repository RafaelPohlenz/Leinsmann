					...
					<div class="panel-body">
						...
						<script>
							...
							*/
							...
							this.page.url = leinsmanncomercial.pe.hu/produtos.php; // Replace PAGE_URL with your page's canonical URL variable
							this.page.identifier = 'produtos1'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
							};
