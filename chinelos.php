				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						*/
						...
						this.page.url = leinsmanncomercial.pe.hu/chinelos.php; // Replace PAGE_URL with your page's canonical URL variable
						this.page.identifier = 'chinelos4'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
						};
